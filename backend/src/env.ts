...
export const envSchema = z.object({
  ...
  // local FE (3000/3001) + the prod domain + the old Vercel URL (kept for tests); override
  // per-environment as needed.
  CORS_ORIGINS: z
    .string()
    .min(1)
    .default(
      'http://localhost:3000,http://localhost:3001,https://app.traderoyale.xyz,https://trade-royale-project.vercel.app',
    ),
